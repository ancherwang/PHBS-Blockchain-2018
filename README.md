...
## Literature Review
Corbet, Lucey, Urquhart and Yarovaya (2017) show that Bitcoin’s role in international diversification has been a controversial research topic among scholars and practitioners because of the importance of having policy impact in asset allocation, hedging and risk management. Indeed, investors and portfolio managers are always looking for alternative investments targets which could reduce the downside risk of traditional assets. As bitcoin became the first crypto currency, investors and academics began testing its ability to diversify its traditional assets because it was independent of sovereign authorities and economic/financial developments.This is also supported by evidence of unique factors driving the price of bitcoin, such as social emotions (Bouoiyour et al., 2015), exchange volume and hash rate, energy price, user anonymity, computer programming hobbyist support, technology, cyber attacks, increasing the uncertainty of the stock market (Bouri, Gupta, et al., 2017), and uncertainty over economic policy (Demir et al., 2018).  

Using the univariate GARCH model, Dyhrberg (2016) shows that bitcoin can be used as a hedge between the FTSE index and the dollar exchange rate.Bouri Molnar et al.(2017) adopted DCC-Garch model and regression analysis involving quantile dummies were used to show that bitcoin can diversify extreme downward movements in stock returns. Using a very similar approach, Baur et al.(2018) demonstrates the weak correlation between bitcoin and stocks, implies the ability to diversify during normal and stressful times, and that bitcoin is 'primarily used as a speculative investment rather than as an alternative currency and medium of exchange.'Using the multivariable GARCH model, Guesmi et al.(2018) shows that adding bitcoin to a portfolio of gold and crude oil stocks results in a lower risk of portfolio gains than the same portfolio excluding bitcoin.Ji et al. reported similar results for bitcoin's ability to hedge.(2018), they used the graph theory method and variance decomposition metric.

Many previous studies have focused on the direct correlation between bitcoin and traditional assets such as stocks, commodities and bonds, and reported evidence of very weak correlation.However, the correlation between bitcoin and traditional assets related to macroeconomic variables such as EPU is still poorly understood.In addition, it is unclear whether the hedging effect of bitcoin is affected by the EPU status.In order to solve these problems, the garch-midas model and its extension dcc-midas  seem to be an appropriate modeling framework.These models have been widely used in the financial literature.Indeed, they continue to attract academic interest because they are able to break down volatility and correlations into long-term and short-term components and combine data from different frequency levels, such as monthly levels of global uncertainty.
...
For other financial market agents, the decision has been to renege on earlier plans to enter the crypto currencies market. Most people have realized the great future downside potential. For example, the famous Sequoia and Polychain Capital, have decided against conducting a Canadian crypto currency initial public offering in January.

## Other potential risks using cryptocurrencies as a hedging/diversification tool
The Other potential risks using cryptocurrencies as a hedging/diversification tool come along with the potential risks of crypto currencies itself. Since all the following drawbacks add the potential risk and volnerability.
While the potential for innovation is well-accepted, still many people have expressed their concerns about cryptocurrencies. Dutch bank ING stated that Bitcoin has many limitations such as a low transaction processing power, excessive energy usage and its inherent volatility. Besides, cryptocurrencies have been criticized for their vulnerability towards criminal activity for years. Abundant criminal organizations can use the loopholes of cryptocurrencies as a channel to complete their transactions, as well as evade taxes. Meanwhile, current technological security is far from enough, past events such as the Mt.Gox hack in 2014, exhibit that the possibility of being hacked remains an evident danger. Researchers have found out that the market has been a subject of manipulation. Researchers even find conclude that suspicious trading activity of a single market participant in 2013 alone led to a price increase of Bitcoin by over 600%.

## Further exploration suggestions
Future papers could propose more potential implication or strategy of Bitcoin hedging or diversification. Also could focus on the time-varying nature of Bitcoin investment, and may pay more attention on the difference of trade time horizons. To be specific, extreme recession or crisis may be a better time to analysis the performance of Bitcoin. However, due to the time limit, we cannot find enough researches using 2018 data. Actually 2018 data may be of great value. Moreover, future papers can analysis the predictive power of different countries’ EPU on the gold or Bitcoin price of different exchanges. Besides, they can pay more attention to other altcoins since they may have different characteristics and different nature of hedging or diversification.Another interesting topic may be whether the Asian Pasific area behave more actively in crypto currencies trading and why the crypto currencies showed stronger hedging/diversification performance in this specific area.

## Summary
According to above researches mentioned，despite the possible theoretical support, crypto currencies are mainly poor hedge and has diversification abilities. No doubt it has very low correlations with nearly all assets, but that does not mean the strong hedging or diversification ability. At least till now, cryptocurrencies are more for speculative purpose. The low correlation in bearish market and high volatility assets, as well as the practical difficulties in trading, make crypto currencies useless under most cases.
## Reference
...
Baur, D. G., Dimpfl, T., & Kuck, K. (2018). Bitcoin, gold and the dollar - a replication and extension. Finance Research Letters, 25.

Bouri, E. , Molnár, Peter, Azzi, G. , Roubaud, D. , & Hagfors, L. I. . (2016). On the hedge and safe haven properties of bitcoin: is it really more than a diversifier?. Finance Research Letters, 20.  
...
Capie, F., Mills, T.C., Wood, G. (2005). “Gold as a Hedge against the dollar.” Journal of International Financial Markets, Institutions and Money vol. 15(4), p. 343–352.

Chohan, U. . (2018). Cryptocurrency hedge fund performance: risks and challenges. SSRN Electronic Journal.

Corbet, S., Lucey, B., & Yarovaya, L. (2017). Datestamping the bitcoin and ethereum bubbles. Social Science Electronic Publishing.

Demir, E., Gozgor, G., Chi, K. M. L., & Vigne, S. A. (2018). Does economic policy uncertainty predict the bitcoin returns? an empirical investigation. Finance Research Letters, 26.

Dyhrberg, A. H. . (2015). Hedging capabilities of bitcoin. is it the virtual gold?. Working Papers, 16, 139-144.

Guesmi, K., Saadi, S., Abid, I., & Ftiti, Z. (2018). Portfolio diversification with virtual currency: evidence from bitcoin ☆. International Review of Financial Analysis, S105752191830173X.

JP Morgan Perspective: Decrypting Cryptocurrencies: Technology, Applications and Challenges,2018 Feb 09

Shan W, Mu T, Yang.Z.Y., Derbali A (2019). Does Gold or Bitcoin Hedge Economic Policy Uncertainty? Finance Research Letters, 2019.

Wong, W. S. , Saerbeck, D. , & Delgado Silva, D. . (2018). Cryptocurrency: a new investment opportunity? an investigation of the hedging capability of cryptocurrencies and their influence on stock, bond and gold portfolios. Social Science Electronic Publishing.
